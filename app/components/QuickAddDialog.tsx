 ...
 * - Tag badges above product title (shared ProductTagList primitive)
...
function QuickAddCartButton({
    ...
    // Without this, opening the dialog after a previous add-to-cart fires onSuccess() immediately

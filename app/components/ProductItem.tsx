            ...
            >
                ...
                {showBadges && (
                    ...
                    >
                        ...
                        {isOutOfStock && (
                            <span
                                className="inline-flex items-center justify-center rounded-full bg-destructive px-2 py-1 text-xs font-medium uppercase tracking-wide text-destructive-foreground shadow-md"
                                role="status"
